...
import { deleteLtServiceTypeApi } from "../../apiservices/L&TServiceTypeApi/L&TServiceTypeApi";
import LtServiceTypeModal from "../../components/Modal/LtServiceTypeModal";
import LtServiceTypeUpdateModal from "../../components/Modal/LtServiceTypeUpdateModal";
import { deleteStandardServiceTypeApi } from "../../apiservices/StandardServiceTypeApi copy/StandardServiceTypeApi";
import StandardServiceTypeModal from "../../components/Modal/StandardServiceTypeModal";
import StandardServiceTypeUpdateModal from "../../components/Modal/StandardServiceTypeUpdateModal";
const StandardServiceType = () => {
    ...
    const deleteData = async (id: string) => {
        ...
        try {
            const response = await deleteStandardServiceTypeApi(id)
            refetch()
    ...
    return <>
        ...
        {showModal ? <StandardServiceTypeModal /> : showUpdateModal ? <StandardServiceTypeUpdateModal singledata={getSingleData} /> : <OutletLayout>
            <div className="">
                <OutletLayoutHeader heading="Standard Service Types">
...
export default StandardServiceType