...
const LtServiceType = () => {
    ...
    const deleteData = async (id: string) => {
        ...
        try {
            const response = await deleteLtServiceTypeApi(id)
            refetch()
    ...
    return <>
        ...
        {showModal ? <LtServiceTypeModal /> : showUpdateModal ? <LtServiceTypeUpdateModal singledata={getSingleData} /> : <OutletLayout>
            <div className="">
