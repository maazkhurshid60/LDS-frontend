...
const Result = () => {
    ...
    return <form className="flex flex-col items-start gap-y-3 overflow-y-auto h-[70vh]" onSubmit={handleSubmit(serviceFilterFunction)}>
     ...
     <TextField onKeyDown={handleEnterKeyPress} register={register} label="Date service" error={errors.dateService} name="dateService" type="date" />

     <TextField onKeyDown={handleEnterKeyPress} register={register} label="Date of 1st Attempt" error={errors.date1Attepmt} name="date1Attepmt" type="date" />
     <TextField onKeyDown={handleEnterKeyPress} register={register} label="Date of 2nd Attempt" error={errors.date2Attepmt} name="date2Attepmt" type="date" />
     <TextField onKeyDown={handleEnterKeyPress} register={register} label="Date of 3rd Attempt" error={errors.date3Attepmt} name="date3Attepmt" type="date" />
     <TextField onKeyDown={handleEnterKeyPress} register={register} label="Date of Mailing" error={errors.dateMailing} name="dateMailing" type="date" />
     <TextField onKeyDown={handleEnterKeyPress} register={register} label="Corp Recipient" error={errors.corpRecipient} name="corpRecipient" />
     <TextField onKeyDown={handleEnterKeyPress} register={register} label="Corp Recipient Title" error={errors.corpRecipientTitle} name="corpRecipientTitle" />
