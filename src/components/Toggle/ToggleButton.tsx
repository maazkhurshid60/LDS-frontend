...
const ToggleButton: React.FC<ToggleButtonProps> = ({ label, value, onChange }) => {
    return (
        <div>
            <label className="inline-flex items-center cursor-pointer flex items-center w-full justify-between">
                ...
                after:transition-all after:duration-[1000ms] dark:border-accentBlue peer-checked:bg-blue-600">
                </div>
