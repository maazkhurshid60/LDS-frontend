...
return <div className="absolute -top-0 -left-0 w-[100%] h-[100%] bg-blackColor/20 z-[99999999999] rounded-lg backdrop-blur-[2px]  flex flex-col items-center  justify-center">
