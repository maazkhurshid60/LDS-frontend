...
const Body: React.FC<bodyProps> = (item) => {
  return <div className="flex flex-col items-start gap-y-2 text-sm">
    <p>I &nbsp;<span className="font-semibold">{item?.serverName ? item?.serverName : "--N/A-- / _____________________________________"}</span>&nbsp;,beign duly swom, deposes and says:</p>
    ...
    <p>ON &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{item?.dateOfService ? item?.dateOfService : "--N/A--/ _____________________________________"} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      {/* AT SOME_TIME_WILL_BE_THERE_FROM_BACKEND_API */}
      , I went to:&nbsp;<span className="font-semibold">{item?.address ? item?.address : "--N/A--/ _____________________________________"}</span>&nbsp;</p>
    ...
    <p>And had a conservation with &nbsp;<span className="font-semibold">{item?.name ? item?.name : "--N/A--/ _____________________________________"}</span>&nbsp; at the subject of premises, I confirmed it was. Because I asked him/her if he/she was the tenant and he/she replied yes I asked the person(s)
    ...
    <p>In addition I asked if &nbsp;<span className="font-semibold">{item?.name ? item?.name : "--N/A--/ _____________________________________"}</span>&nbsp; was in the military service of the United State or the state of New York
    ...
    <div className="font-semibold flex items-center justify-between w-full">
            ...
            <p>{item?.mailingAddressDate? item?.mailingAddressDate:"--N/A--/ _____________________________________"}</p>
            </div>
            <div>
            <p><span className="font-semibold">{item?.serverName ? item?.serverName : "--N/A--/ _____________________________________"}</span></p>
            <p>Lic#{item?.serverLicense? item?.serverLicense:"--N/A--/ _____________________________________"}</p>
            <p><span className="font-semibold capitalize">{item?.serverAddress ? item?.serverAddress : "--N/A--/ _____________________________________"}</span>
            </p>
