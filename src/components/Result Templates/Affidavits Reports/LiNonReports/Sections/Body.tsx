...
const Body: React.FC<bodyProps> = (item) => {
    return <div className="flex flex-col gap-y-4">
        ...
        <p>ON <span className="font-semibold">{item?.dateOfService ? item?.dateOfService :"--N/A--" }</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
            {/* AT SOME_TIME_WILL_BE_THERE_FROM_BACKEND_API */} , I went to _____________________________________
            </p>
       
        <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;And had a conservation with _______________________________________ (relative/resides at premises) at the subject premises, I asked
            the person(s) spoken to whether said tenant(s) and/or Undertenant(s) sued here in as _______________________________________ and
            _______________________________________ was in the military service of United Service or the State of New York in any capacity
        ...
        <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;And had a conservation with _______________________________________ who is employed as superintendent, and lives at the same address
        ...
        <p>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;And had a conservation with _______________________________________ (relative/resides at premises) at the subject premises,I asked
            the person(s) spoken to whether said tenant(s) and/or Undertenant(s) sued here in as _______________________________________ and
            _______________________________________ was in the military service of United Service or the State of New York in any capacity
            and the person(s) informed me that said tenant(s)/Undertenant(s) were not in the military service, nor was the tenant(s)/Undertenant(s)
            or any one in said tenant(s)/Undertenant(s) family dependent on any person in the military service of the United States.
        ...
        <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;And had a conservation with _______________________________________ who is employed as Administrator by the petitioner concerning the
