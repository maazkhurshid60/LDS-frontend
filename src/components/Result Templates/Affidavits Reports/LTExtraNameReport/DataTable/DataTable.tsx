    ...
    return < div className="relative overflow-x-auto" >
        <table className="w-full text-sm border-[2px] border-solid border-blackColor ">
            <thead className="text-xs  border-[2px] border-solid border-blackColor">
                <tr>
                    <th scope="col" className="px-1 py-1 text-xs border-[1px] border-solid border-blackColor">
                        Case#/DOM
                    </th>
                    <th scope="col" className="px-1 py-1 text-xs border-[1px] border-solid border-blackColor">
                        Case Paper
            ...
            <tbody>
                {item?.data?.map(data => <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-[2px] border-solid border-blackColor">
                    ...
                    <td className="px-3 py-3 text-xs border-[1px] border-solid border-blackColor">
                        {data?.lTSAddress ? data?.lTSAddress : "________"}                        </td>
                    <td className="px-3 py-3 text-xs border-[1px] border-solid border-blackColor">
                    ...
                    </td><td className="px-3 py-3 text-xs border-[1px] border-solid border-blackColor">
                        -
                    </td>
